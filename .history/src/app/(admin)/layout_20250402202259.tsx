      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
        ...
        {mobileSidebarOpen && (
          <div className="fixed inset-0 z-40 flex">
            <div className="fixed inset-0 bg-black opacity-50" onClick={mobileSidebarToggle} />
        ...
        <div className="flex-1 flex flex-col">
          ...
          <main className="ml-0 md:ml-64 mt-16 p-4 sm:p-6 lg:p-8 overflow-auto">{children}</main>
        </div>
      </div>
    </AdminProvider>
  );

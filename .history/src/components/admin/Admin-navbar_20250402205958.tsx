  ...
  return (
    <header className="fixed w-full z-50 bg-white dark:bg-gray-800 border-b dark:border-gray-700 top-0 left-0">
      <div className="flex h-16 items-center justify-between px-4">
        {/* Botón para activar sidebar móvil */}
        ...
        {/* Input de búsqueda: visible solo en escritorio */}
        <div className="hidden md:block relative">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400" />
          <Input
            type="search"
            placeholder="Buscar en el sistema..."
            className="pl-10 pr-4 py-2 w-full md:w-96 rounded-xl bg-gray-50 dark:bg-gray-700 border-none"
          />
        </div>
